...
#define CHANGE_NUMPADTO_ENGLISHPAD		(WM_USER+2)
#define CHANGE_SIGNPADTO_ENGLISHPAD	    (WM_USER+3)
#define CHANGE_SIGNPAD					(WM_USER+4)
#define CHANGE_CHINESE_PY               (WM_USER+5)
