...
#include "stm32f4xx.h"
#define WINT8U_F     unsigned char
#define WINT16U_F    unsigned short int
#define WINT32U_F    unsigned int
...
#define  NAND_CMD_AREA_A           ((WINT8U_F)0x00)
#define  NAND_CMD_AREA_B           ((WINT8U_F)0x01)
#define NAND_CMD_AREA_C            ((WINT8U_F)0x50)
#define NAND_CMD_AREA_TRUE1        ((WINT8U_F)0x30)

#define NAND_CMD_WRITE0            ((WINT8U_F)0x80)
#define NAND_CMD_WRITE_TRUE1       ((WINT8U_F)0x10)

#define NAND_CMD_ERASE0            ((WINT8U_F)0x60)
#define NAND_CMD_ERASE1            ((WINT8U_F)0xD0)

#define NAND_CMD_READID            ((WINT8U_F)0x90)

#define NAND_CMD_LOCK_STATUS       ((WINT8U_F)0x7A)
#define NAND_CMD_RESET             ((WINT8U_F)0xFF)

/* NAND memory status */
#define NAND_BUSY                  ((WINT8U_F)0x00)
#define NAND_ERROR                 ((WINT8U_F)0x01)
#define NAND_READY                 ((WINT8U_F)0x40)
#define NAND_TIMEOUT_ERROR         ((WINT8U_F)0x80)
...
/* 用于HY27UF081G2A    K9F1G08 */
  ...
  /* 命令代码定义 */
  #define NAND_CMD_COPYBACK_A      ((WINT8U_F)0x00)      /* PAGE COPY-BACK 命令序列 */
  #define NAND_CMD_COPYBACK_B      ((WINT8U_F)0x35)
  #define NAND_CMD_COPYBACK_C      ((WINT8U_F)0x85)
  #define NAND_CMD_COPYBACK_D      ((WINT8U_F)0x10)

  #define NAND_CMD_STATUS          ((WINT8U_F)0x70)    /* 读NAND Flash的状态字 */
...
#define ADDR_1st_CYCLE(ADDR)       (WINT8U_F)((ADDR)& 0xFF)               /* 1st addressing cycle */
#define ADDR_2nd_CYCLE(ADDR)       (WINT8U_F)(((ADDR)& 0xFF00) >> 8)      /* 2nd addressing cycle */
#define ADDR_3rd_CYCLE(ADDR)       (WINT8U_F)(((ADDR)& 0xFF0000) >> 16)   /* 3rd addressing cycle */
#define ADDR_4th_CYCLE(ADDR)       (WINT8U_F)(((ADDR)& 0xFF000000) >> 24) /* 4th addressing cycle */
