...
u32 fupd_prog(u16 x,u16 y,u8 size,u32 fsize,u32 pos)
{
	...
	if(t!=prog)
	{
		RA8875_DispAscii(x+3*size/2,y,"%");		
		t=prog;
		if(t>100)t=100;
		RA8875_DispNum(x,y,t);//显示数值
	}
	return 0;					    
} 
//更新某一个
...
{	
	...
	if(rval==0)//字库文件都存在.
	{  
		RA8875_DispAscii(x,y,"Erasing sectors... ");//提示正在擦除扇区	
