...
u32 fupd_prog(u16 x,u16 y,u8 size,u32 fsize,u32 pos)
{
	...
	if(t!=prog)
	{
		LCD_ShowString(x+3*size/2,y,480,854,size,"%");		
		t=prog;
		if(t>100)t=100;
...
{	
	...
	if(rval==0)//字库文件都存在.
	{  
		LCD_ShowString(x,y,480,854,size,"Erasing sectors... ");//提示正在擦除扇区	
