...
{	 
  ...
  GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化
	...
	//这里只针对SPI口初始化
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_SPI2,DISABLE);//复位SPI2
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_SPI2,ENABLE);//停止复位SPI2
...
{	 
  ...
  GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化
	...
	//这里只针对SPI口初始化
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_SPI1,DISABLE);//复位SPI1
